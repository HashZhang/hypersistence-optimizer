...
```bash
> unzip hypersistence-optimizer-2.3.0-trial-pack.zip
```

After unzipping the project package, you will get the following file structure:

```bash
creating: hypersistence-optimizer-2.3.0-trial/
   creating: hypersistence-optimizer-2.3.0-trial/lib/
  inflating: hypersistence-optimizer-2.3.0-trial/lib/hypersistence-optimizer-2.3.0-trial-javadoc.jar
  inflating: hypersistence-optimizer-2.3.0-trial/lib/hypersistence-optimizer-2.3.0-trial-sources.jar
  inflating: hypersistence-optimizer-2.3.0-trial/lib/hypersistence-optimizer-2.3.0-trial.jar
   creating: hypersistence-optimizer-2.3.0-trial/docs/
   creating: hypersistence-optimizer-2.3.0-trial/docs/html/
   creating: hypersistence-optimizer-2.3.0-trial/docs/pdf/
  inflating: hypersistence-optimizer-2.3.0-trial/docs/html/asciidoctor.css
  inflating: hypersistence-optimizer-2.3.0-trial/docs/html/coderay-asciidoctor.css
  inflating: hypersistence-optimizer-2.3.0-trial/docs/pdf/InstallationGuide.pdf
  inflating: hypersistence-optimizer-2.3.0-trial/docs/html/InstallationGuide.html
  inflating: hypersistence-optimizer-2.3.0-trial/docs/html/UserGuide.html
  inflating: hypersistence-optimizer-2.3.0-trial/docs/pdf/UserGuide.pdf
  inflating: hypersistence-optimizer-2.3.0-trial/changelog.txt
  inflating: hypersistence-optimizer-2.3.0-trial/LICENSE.txt
  inflating: hypersistence-optimizer-2.3.0-trial/maven-install.bat
  inflating: hypersistence-optimizer-2.3.0-trial/maven-install.sh
  inflating: hypersistence-optimizer-2.3.0-trial/README.txt
```
...
* `hypersistence-optimizer-2.3.0-trial/docs/pdf/InstallationGuide.pdf`
* `hypersistence-optimizer-2.3.0-trial/docs/html/InstallationGuide.html`
...
* `hypersistence-optimizer-2.3.0-trial/docs/html/UserGuide.html`
* `hypersistence-optimizer-2.3.0-trial/docs/pdf/UserGuide.pdf`
